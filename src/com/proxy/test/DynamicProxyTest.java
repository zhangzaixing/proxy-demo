...
import com.proxy.ticket.Station;
import com.proxy.ticket.TicketService;
...
public class DynamicProxyTest {
	...
	public static void main(String[] args) throws Exception {  
	    ...
	    {  
	        ...
	        CtClass cc = pool.makeClass("com.proxy.ticket.StationProxy");  
	          
	        //设置接口  
	        CtClass interface1 = pool.get("com.proxy.ticket.TicketService");  
	        cc.setInterfaces(new CtClass[]{interface1});  
	          
	        //设置Field  
	        CtField field = CtField.make("private com.proxy.ticket.Station station;", cc);  
	          
	        cc.addField(field);  
	          
	        CtClass stationClass = pool.get("com.proxy.ticket.Station");  
